...
class GhostNet(nn.Module):
    def __init__(self,cfg_out, cfgs, num_classes=1000, width=1.0, dropout=0.2):
        ...
        self.final_layer = nn.Conv2d(
            in_channels=256,
            out_channels=cfg_out['MODEL']['NUM_JOINTS'],
            kernel_size=1,
            stride=1,
            padding=0
        )
...
def ghostnet(cfg,**kwargs):
    ...
    return GhostNet(cfg,cfgs, **kwargs)
