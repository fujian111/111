...
class PoseHigherResolutionNet(nn.Module):
    def __init__(self,cfg, **kwargs):
        ...
        # with open('D:/biye/hrnetoff/off_hrnet/experiments/coco/efficientnet_hrnet/frozen.yaml', 'r') as file:
        #     cfg = yaml.safe_load(file)
        with open('D:/biye/hrnetoff/off_hrnet/experiments/mpii/efficientnet_hrnet/frozen.yaml', 'r') as file:
            cfg = yaml.safe_load(file)
        # print("aaaaaaaaaaa",cfg['MODEL'])
        # print("555555555555550",cfg['MODEL']['DEPTH_MULT'])
    ...
    def forward(self, x):
        ...
        # print("final_outputs",len(y_list))
        # print("y_list", y_list[0].shape, y_list[1].shape, y_list[2].shape, y_list[3].shape)
        ...
        # print("final_outputs",final_outputs[0].shape,final_outputs[1].shape)
        # print("final_outputs", final_outputs[2].shape, final_outputs[3].shape)
        # print("gggggggggggggg",final_outputs[0].shape)
